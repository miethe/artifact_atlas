---
title: "Layered Context Governance"
description: "Defines context layers (Layer 0-5), token budgets per layer, drift check cadence, and ownership model."
type: policy
domain: ai-config
status: active
load_when: "When planning context discovery strategy"
related:
  - .claude/context/key-context/context-loading-playbook.md
  - .claude/specs/context-file-schema.md
---
