...
description: "Comprehensive debugging methodology, bug categories, investigation commands, and agent delegation patterns using symbols-first approach."
type: guide
domain: general
status: active
audience: ai-agents
...
related:
  - .claude/context/key-context/symbols-query-playbook.md
  - .claude/specs/script-usage/bug-automation-scripts.md
load_when: "When debugging or investigating a bug"
---
