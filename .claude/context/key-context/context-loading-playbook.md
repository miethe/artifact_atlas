---
title: "Context Loading Playbook"
description: "Task-to-context routing matrix and loading ladder for minimizing tokens and stale-context risk."
type: playbook
domain: meta
status: active
last_verified: 2026-05-26
related:
  - .claude/context/key-context/agent-roster.md
  - .claude/context/key-context/dev-commands.md
  - .claude/context/key-context/cross-cutting-patterns.md
---
...
|---|---|---|
| Agent selection / delegation | `CLAUDE.md` § Agent Delegation | `agent-roster.md` |
| CLI/setup commands | `CLAUDE.md` § Development Commands | `dev-commands.md` |
| Manifest/lock files, GitHub client, Python compat | `CLAUDE.md` § Key Cross-Cutting Patterns | `cross-cutting-patterns.md` |
