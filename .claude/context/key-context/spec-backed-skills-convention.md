---
title: "Spec-Backed Skills Convention"
description: "Defines SPEC.md versioned capability contracts for skills alongside SKILL.md, including coverage matrix and roadmap patterns."
type: guide
domain: ai-config
status: active
load_when: "When configuring Claude Code or designing multi-agent systems"
---
