...
description: "Comprehensive Next.js 15 App Router patterns covering server/client components, data fetching, and page structure."
type: patterns
domain: frontend
status: active
audience: developers
...
load_when: "When working on Next.js app routes or server/client patterns"
---
