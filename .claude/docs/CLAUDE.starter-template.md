...
Artifact Atlas: Asset graph, Artifact BOM, and context-pack builder for the Agentic OS

> Created: 2026-06-20 | Author: Nick Miethe
...
Next.js/React/TS frontend, FastAPI/Pydantic backend, local-first JSONL/SQLite registry (Postgres/pgvector later), read-first MCP + atlas CLI agent gateway.
